...
print("gates1.jpeg 是Bill gates吗? {}".format(results1[0]))
print("gates1.jpeg 是Meinv吗? {}".format(results1[1]))
print("gates1.jpeg 是未识别的新人吗? {}".format(not True in results1))
print("gates1.jpeg 与照片库的距离（越远，置信度越低）： {}" . format(face_distances))
...
print("unknown.png 是Bill gates吗? {}".format(results[0]))
print("unknown.png 是Meinv吗? {}".format(results[1]))
print("unknown.png 是未识别的新人吗? {}".format(not True in results))
